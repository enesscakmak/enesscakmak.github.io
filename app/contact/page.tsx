            ...
            <div className="grid gap-8">
              <div>
                ...
                <p className="text-base text-zinc-700 dark:text-zinc-400 mb-6">
                  I am looking for internship opportunities especially in the front end field. I'm always interested in hearing about new projects and opportunities. Whether you have a question or just want to say hi, feel free to reach out through email or social media.
                </p>
              </div>
              ...
              <Card className="bg-white/80 dark:bg-zinc-800/50 p-6 border-zinc-200 dark:border-zinc-700
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    <h2 className="text-lg font-semibold mb-2 text-zinc-900 dark:text-zinc-50">Connect on Social Media</h2>
                    <p className="text-base text-zinc-700 dark:text-zinc-400 mb-4">
